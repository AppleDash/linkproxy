...
class Line:
    ...
    >>> repr(Line.parse(line=':lol.org PRIVMSG'))
    'Line(:lol.org PRIVMSG)'
    >>> repr(Line.parse(line='PING'))
    'Line(PING)'
    >>> repr(Line.parse(line='PING Elizacat'))
    'Line(PING Elizacat)'
    >>> repr(Line.parse(line='PING Elizacat :dongs'))
    'Line(PING Elizacat :dongs)'
    >>> repr(Line.parse(line='PING :dongs'))
    'Line(PING :dongs)'
    >>> repr(Line.parse(line=':dongs!dongs@lol.org PRIVMSG loldongs meow :dongs'))
